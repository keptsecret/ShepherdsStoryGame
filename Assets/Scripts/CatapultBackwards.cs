...
public class CatapultBackwards : MonoBehaviour
{
    ...
    void Jump()
    {
        ...
        //playerRigidbody.AddForce(-Vector3.forward * 4000.0f, ForceMode.Impulse);
    ...
    void sheepJump(Rigidbody sheepRigidbody)
    {
        ...
        sheepRigidbody.AddForce(-Vector3.forward * 250.0f, ForceMode.Impulse);
